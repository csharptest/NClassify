...
namespace NClassify.Example
{
    ...
    public partial struct SimpleInt32 : global::System.IEquatable<SimpleInt32>, global::System.IComparable<SimpleInt32>, global::NClassify.Library.IValidate
    {
        ...
        public bool IsValid()
        {
            return 0 == GetBrokenRules(null);
        }
        public void AssertValid()
        {
            GetBrokenRules(delegate(global::NClassify.Library.ValidationError e) { throw new global::System.IO.InvalidDataException(e.Message); });
        }
    ...
    public partial class SampleMsg : global::System.ICloneable, global::System.Xml.Serialization.IXmlSerializable, global::NClassify.Library.IMessage
    {
        ...
        partial class _ReadErrors : global::System.Collections.Generic.IList<string>, global::System.ICloneable
        {
            ...
            public _ReadErrors(global::System.Collections.Generic.IList<string> contents, bool readOnly)
            {
                _readOnly = readOnly;
            ...
            public _ReadErrors AsReadOnly()
            {
                if (IsReadOnly) return this;
                return new _ReadErrors(_contents, true);
            }
            ...
            {
                return new _ReadErrors(this, false);
            }
        ...
        public static bool IsValidReadErrors(string value, global::System.Action<global::NClassify.Library.ValidationError> onError)
        {
            if (object.ReferenceEquals(null, value))
            {
                if (onError != null) onError(new global::NClassify.Library.ValidationError(TypeFields.Errors, global::NClassify.Library.Resources.MustNotBeNull, TypeFields.Errors));
                return false;
            }
            if (value.Length > 0)
            {
                if (onError != null) onError(new global::NClassify.Library.ValidationError(TypeFields.Errors, global::NClassify.Library.Resources.MustBeShorterThan, TypeFields.Errors, 0));
                return false;
            }
            return true;
        }
        public static bool IsValidChildrenList(global::NClassify.Example.SampleMsg value, global::System.Action<global::NClassify.Library.ValidationError> onError)
        {
            if (object.ReferenceEquals(null, value))
            {
                if (onError != null) onError(new global::NClassify.Library.ValidationError(TypeFields.Children, global::NClassify.Library.Resources.MustNotBeNull, TypeFields.Children));
                return false;
            }
            if (!value.IsValid())
            {
                ...
                global::System.Collections.Generic.List<global::NClassify.Library.ValidationError> errors = new global::System.Collections.Generic.List<global::NClassify.Library.ValidationError>();
                value.GetBrokenRules(errors.Add);
                onError(new global::NClassify.Library.ValidationError(TypeFields.Children, errors));
                return false;
            }
            return true;
        }
        ...
        public void MergeFrom(SampleMsg other)
        {
            ...
            if (other.__has_clear) __fld_clear = other.__fld_clear;
            if (other.__has_initialize) __fld_initialize = other.__fld_initialize;
            if (other.__has_mergeFrom) __fld_mergeFrom = other.__fld_mergeFrom;
        ...
        public void MergeTo(global::System.Xml.XmlWriter writer)
        {
            if (__has_id)
            {
